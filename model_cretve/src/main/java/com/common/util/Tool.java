...
//        email.putExtra(android.content.Intent.EXTRA_TEXT, emailContent);
    ...
    public static void showMessageDialog(int string, Context activity) {
        if (null == activity || ((Activity) activity).isFinishing()) {
            return;
        }
        Builder builder = new Builder(activity);


        builder.setMessage(activity.getResources().getString(string));
//        builder.setTitle("Notification");

        String confirm=activity.getResources().getString(R.string.confirm);
    ...
    public static void showMessageDialog(String message, Context activity) {
...
//        builder.setTitle("Notification");
    ...
    public static void showMessageDialog(String message, Activity activity, final DialogCallBackListener dialogCallBackListener) {
...
//        builder.setTitle("Notification");
    ...
    public static void showMessageDialog(int message, Activity activity, final DialogCallBackListener dialogCallBackListener) {
